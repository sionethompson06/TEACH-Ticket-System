...
export default async function SupportQueuePage({
  ...
  if (!isSupportStaff(actor)) {
    return (
      <FriendlyState
        title="Support workspace access"
        message="You don't have access to the support workspace. If you believe this is a mistake, contact your system administrator."
